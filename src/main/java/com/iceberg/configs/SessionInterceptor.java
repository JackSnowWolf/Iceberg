...
//        System.out.println("session:"+uri);
        ...
        if("/".equals(uri) || "/login.html".equals(uri) || "/login.do".equals(uri) || uri.contains("/static/") || uri.startsWith("/oauth")){
...
//        System.out.println(request.getRequestURI());
        ...
        String uri = request.getRequestURI();
        if("/logout".equals(uri) || "/".equals(uri) || "/login.html".equals(uri) || uri.startsWith("/static") || uri.startsWith("/oauth")) {
