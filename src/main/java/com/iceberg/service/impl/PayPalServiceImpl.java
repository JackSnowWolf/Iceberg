...
public class PayPalServiceImpl extends PayPalClient implements PayPalService {
    ...
    @Override
    public HttpResponse<CreatePayoutResponse> createPayout(String receiver, String currency, String value) throws IOException {
    ...
    public PayoutsPostRequest buildRequestBody(String receiver, String currency, String value) {
        List<PayoutItem> items = IntStream
                ...
                .mapToObj(index -> new PayoutItem()
                        .senderItemId("Test_IceBerg_" + index)
                        .note("Your"+ value +"Payout!")
                        .receiver(receiver)
                        .amount(new Currency()
                                .currency(currency)
                                .value(value)))
        ...
        CreatePayoutRequest payoutBatch = new CreatePayoutRequest()
                .senderBatchHeader(new SenderBatchHeader()
                        ...
                        .emailSubject("This is a transaction from IceBerg")
