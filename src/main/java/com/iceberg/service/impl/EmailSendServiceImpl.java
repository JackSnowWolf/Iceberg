...
import com.iceberg.service.EmailSendService;
...
public class EmailSendServiceImpl implements EmailSendService {
    ...
    public String postConfirm(UserInfo userInfo, ReimbursementRequest reimbursementRequest) {
        ...
        String text = "Dear " + to + ",\n"
                + "You have successfully posted a reimbursement request (" + requestId + ") on our website. "
    ...
    public String denyConfirm(UserInfo userInfo, ReimbursementRequest reimbursementRequest) {
        ...
        msg.setSubject("Reimbursement Request Approved");
        String text = "Dear " + to + ",\n"
                + "Sorry to inform you that your reimbursement request (" + requestId + ") has been denied. "
                + "For more information, please reach out to your account.\n\n"
                + "Iceberg Team";
        msg.setText(text);
        try {
            javaMailSender.send(msg);
