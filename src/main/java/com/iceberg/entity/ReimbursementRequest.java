...
//    // typeid, realname, paywayid, payway, starttime, endtime
  ...
  // Can change the variable type name similar to status: submitted, approved,
  // rejected
  private String type; // rei type: 1 rei output (reimbursement request); 2 rei input (approved
  ...
  // This is like the type in Chong Hu's mind. We can set remark to: taxi fee,
  ...
  public String toString() {
    return "Bill{" + "id=" + id + ", title='" + title + '\'' + ", type='" + type + '\'' + ", typeid='" + typeid + '\''
        + ", money=" + money + ", userid=" + userid + ", realname='" + realname + '\'' + ", remark='" + remark + '\''
        + ", paywayid='" + paywayid + '\'' + ", payway='" + payway + '\'' + ", time='" + time + '\'' + ", startTime='"
