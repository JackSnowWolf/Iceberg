...
;layui.define("layer", function (e) {
  ...
  p.prototype.config = {
    ...
    var n, o = this, l = o.config, r = o.elemFile[0], u = function () {
      var t = 0, n = 0, a = e || o.files || o.chooseFiles || r.files,
          u = function () {
            ...
            == typeof l.allDone && l.allDone(
                {total: o.fileLength, successful: t, aborted: n})
          };
      ...
      o.elemFile.parent().submit(), clearInterval(
        ...
        try {
          ...
          o.msg("Get response error!"), clearInterval(p.timer), m()
        }
      ...
      != typeof i) {
        try {
          ...
          return i = {}, o.msg("Pleas upload valid JSON")
        }
      }
      ...
      if ("choose" !== t && !l.auto || (l.choose && l.choose(g), "choose"
      !== t)) {
        return l.before && l.before(g), a.ie ? a.ie > 9 ? u() : c()
            : void u()
      }
    };
    if (v = 0 === v.length ? r.value.match(/[^\/\\]+\..+/g) || [] || "" : v, 0
    !== v.length) {
      switch (l.accept) {
        case"file":
          if (h && !RegExp("\\w\\.(" + h + ")$", "i").test(
              escape(v))) {
            return o.msg("Selected files not supported!"), r.value = "";
          }
          break;
        case"video":
          if (!RegExp(
              ...
              "i").test(escape(v))) {
            return o.msg(
                "Selected videos not supported!"), r.value = "";
          }
          break;
        case"audio":
          if (!RegExp("\\w\\.(" + (h || "mp3|wav|mid") + ")$", "i").test(
              escape(v))) {
            return o.msg("Selected audios not supported!"), r.value = "";
          }
          break;
        default:
          if (layui.each(v, function (e, i) {
            ...
            return o.msg("Selected images not supported!"), r.value = ""
          }
      }
      if (o.fileLength = function () {
        ...
        return o.msg(
            "Only can upload " + l.number + " files at same time");
      }
      if (l.size > 0 && !(a.ie && a.ie < 10)) {
        ...
        if (layui.each(o.chooseFiles, function (e, i) {
          ...
          return o.msg("file can not exceeds" + F)
        }
      }
      y()
    }
    ...
    var e = this, t = e.config, o = function (i) {
      ...
      var a = e.elemFile,
          o = i.length > 1 ? i.length + "" : (i[0] || {}).name
              || a[0].value.match(/[^\/\\]+\..+/g) || [] || "";
